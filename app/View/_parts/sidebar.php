                        ...
                        foreach ($details['children'] as $name2 => $details2) { // Level 2
                            ...
                            if (isset($details2['children']) !== false) {
                                foreach ($details2['children'] as $name3 => $details3) { // Level 3
                                    ...
                                    $subLinks3 .= '<a class="dropdown-item' . ($active3 ? ' active' : '') . '" href="' . $Helper::base($details3['link']) . '">' . $Helper::lang('base.' . $name3) . '</a>';
                            ...
                            $subLinks2 .= !empty($subLinks3) ? '<div class="dropend">
                                    ...
                                    <div class="dropdown-menu' . ($level3HasActive ? ' show' : '') . '">' . $subLinks3 . '</div>' : '<a class="dropdown-item' . ($active2 ? ' active' : '') . '" href="' . $Helper::base($details2['link']) . '">' . $Helper::lang('base.' . $name2) . '</a>';
